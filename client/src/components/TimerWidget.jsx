			...
			<div className={styles.right}>
				<div className={styles.configure}>
					<div className={styles.cell}>
						<p>Hours</p>
						<BiSolidUpArrow style={{"cursor":"pointer"}} onClick={() => stepHandler(HOURS_STEP)} />
						<p>{parseTime(cachedSeconds).hours}</p>
						<BiSolidDownArrow style={{"cursor":"pointer"}} onClick={() => stepHandler(-HOURS_STEP)} />
					</div>
					<div className={styles.cell}>
						<p>Minutes</p>
						<BiSolidUpArrow
						...
						/>
						<p>{parseTime(cachedSeconds).minutes}</p>
						<BiSolidDownArrow
						style={{"cursor":"pointer"}}
							onClick={() =>
								stepHandler(-MINUTES_STEP)
							}
						/>
					</div>
					<div className={styles.cell}>
						...
						/>
						<p>{parseTime(cachedSeconds).seconds}</p>
						<BiSolidDownArrow
						style={{"cursor":"pointer"}}
							onClick={() =>
								stepHandler(-SECONDS_STEP)
							}
						/>
					</div>
				</div>
